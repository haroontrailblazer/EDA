...
fig.update_traces(error_y=dict(type='data', array=[2,2,2,4,2,5,3,3,3,4,1,3,5,3,1,1,3,3,2,2,3,4,3,2,3,4,2,1,3,5,2,2,2,3,4,4,3,2,2,2,1,2,4,3,5,6,1,2,3,3], visible=True))
